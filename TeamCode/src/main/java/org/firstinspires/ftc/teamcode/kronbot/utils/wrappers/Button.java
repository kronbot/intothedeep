...
public class Button {
    ...
    /**
     * Simulates a short press programmatically without physical input.
     */
    public void simulateShortPress() {
        // Simulate the button being pressed
        buttonValue = true;
        shortLastIteration = false;
        shortCurrentIteration = true;

        // Trigger the short press behavior
        shortPress();

        // Release the button
        buttonValue = false;
        shortLastIteration = true;
        shortCurrentIteration = false;
    }
}
