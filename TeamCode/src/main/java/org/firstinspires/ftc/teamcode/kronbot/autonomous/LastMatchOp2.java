...
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.EigthPose2;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.EleventhPose;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.EleventhPose2;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.FifthPose;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.FifthPose2;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.FirstPose;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.FirstPose2;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.FourthPose;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.FourthPose2;
...
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.NinthPose2;
...
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.SecondPose2;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.SeventhPose;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.SeventhPose2;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.SixthPose;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.SixthPose2;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.TenthPose;
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.TenthPose2;
...
import static org.firstinspires.ftc.teamcode.kronbot.utils.autonomous.AutonomousConstants.ThirdPose2;
...
@Autonomous(name = "Last Match 2", group = Constants.MAIN_GROUP)
public class LastMatchOp2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d pose1 = coordinatesConvert(FirstPose2);
        Pose2d pose2 = coordinatesConvert(SecondPose2);
        Pose2d pose3 = coordinatesConvert(ThirdPose2);
        Pose2d pose4 = coordinatesConvert(FourthPose2);
        Pose2d pose5 = coordinatesConvert(FifthPose2);
        Pose2d pose6 = coordinatesConvert(SixthPose2);
        Pose2d pose7 = coordinatesConvert(SeventhPose2);
        Pose2d pose8 = coordinatesConvert(EigthPose2);
        Pose2d pose9 = coordinatesConvert(NinthPose2);
        Pose2d pose10 = coordinatesConvert(TenthPose2);
        Pose2d pose11 = coordinatesConvert(EleventhPose2);
